...
import type { MeetingGetManyOutput } from "../../types";
...
export const columns: ColumnDef<MeetingGetManyOutput["meetings"][number]>[] = [
  {
    accessorKey: "title",
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <Badge
        variant="outline"
        className="capitalize [&_svg]:size-4 flex items-center gap-x-2"
      >
